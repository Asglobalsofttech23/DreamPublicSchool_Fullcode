                        ...
                        <TableBody>
                            {filteredStudents.map((student) => (
                                <TableRow key={student.stu_id}>
                                    ...
                                    <TableCell style={{color:"red",fontWeight:"bolder"}}>{student.vanRemaningFees}</TableCell>
                                    <TableCell className="no-print"> {/* Added class for hiding on print */}
                                    <Link to={`/vanpayfees/${student.stu_id}`}>  <Button style={{ marginTop: "20px", }} startIcon={<Edit />} variant='contained' color='info'>Pay fees</Button></Link>
